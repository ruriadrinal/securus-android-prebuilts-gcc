...
enum opt_code
{
  ...
  OPT_mrestrict_it = 1208,                   /* -mrestrict-it */
  OPT_msched_prolog = 1209,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1210,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1211,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1212, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1213,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1214,                         /* -mthumb */
  OPT_mthumb_interwork = 1215,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1216,                  /* -mtls-dialect= */
  OPT_mtp_ = 1217,                           /* -mtp= */
  OPT_mtpcs_frame = 1218,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1219,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1220,                         /* -mtune= */
  OPT_munaligned_access = 1221,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1222,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1223,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1224,              /* -mword-relocations */
  OPT_n = 1225,                              /* -n */
